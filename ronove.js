...
const didin = fs.readFileSync('./stik/didin.jpeg')
...
// l Bang:)
    const ftroli = {
      key: {
        fromMe: false,
        participant: "6281545463585@s.whatsapp.net",
      ...
      message: {
        orderMessage: {
          ...
          message: iye,
          orderTitle: "ronove.",
          sellerJid: "6281545463585@s.whatsapp.net",
        },
      },
      contextInfo: { forwardingScore: 999, isForwarded: true },
      sendEphemeral: true,
    };
const fgif7 = { key: { fromMe: false, participant: `6281545463585@s.whatsapp.net`, ...(from ? { remoteJid: '1595603042@s.whatsapp.net' } : {}) }, message: { "productMessage":{"product": {"productImage": {"mimetype":'image/jpeg',"jpegThumbnail": iye, "title": `${ucapanWaktu} ${pushname}`, "productImageCount": 1 }, "businessOwnerJid": `6281545463585@s.whatsapp.net` }}}
}
 const fkontak = { 
                  key: {fromMe: false,participant: `6281545463585@s.whatsapp.net`, ...(from ? { remoteJid: `6281545463585@s.whatsapp.net` } : {}) }, message: { 'contactMessage': { 'displayName': `${pushname}`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;${pushname},;;;\nFN:${pushname},\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': fs.readFileSync('./stik/thumb.jpeg')}}}
            //FAKE STICKER
            const fsticker = {
...
if (!m.isBaileys && isGroup && isBadword && !isOwner && !isGroupAdmins && !mek.key.fromMe){
    ...
    if (isGroup && isKickarea && !mek.key.fromMe) {
      if (sender.includes("62")) {
        ...
        const sendmenu = (teks) => {
        	//by ronove
                    ronove.sendMessage(from, { contentText: teks, footerText: `Created by ${namaowner}`, buttons: [{ buttonId: `command`, buttonText: { displayText: 'ʙʏ ᴅɪᴅɪɴ️' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: iye, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
                    }
...
switch (command) {
//no gua/ptod jangan lu ganti anjing
case 'help':
case 'menu':
...
ptod = "6281545463585@s.whatsapp.net"
       ...
       stst = await ronove.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			menu = `*ʜᴀʟᴏ ${pushname}*`
sendButLocation(from, `${menu}`, `*sᴀʏᴀ ᴅɪᴅɪɴʙᴏᴛ, ʙᴏᴛ ᴡʜᴀᴛsᴀᴘᴘ ʏᴀɴɢ ᴍᴇᴍʙᴀɴᴛᴜ ᴀɴᴅᴀ ᴜɴᴛᴜᴋ ᴍᴇᴍᴘᴇʀᴍᴜᴅᴀʜ sᴇsᴜᴀᴛᴜ sᴇᴘᴇʀᴛɪ ᴍᴇᴍʙᴜᴀᴛ sᴛɪᴄᴋᴇʀ ᴅᴀɴ ʟᴀɪɴɴʏᴀ.*

*ɴᴏᴛᴇ  :*
•ᴊɪᴋᴀ ᴋᴀᴍᴜ ᴍᴇɴɢɢᴜɴᴀᴋᴀɴ ᴡᴀ ᴍᴏᴏᴅ ᴅᴀɴ ʙᴜᴛᴛᴏɴ ɢᴋ ᴋᴇʟɪᴀᴛᴀɴ,ʟᴀɴɢsᴜɴɢ ᴀᴊᴀ ᴋᴇᴛɪᴋ .ᴀʟʟᴍᴇɴᴜ
• ʙᴏᴛ ᴍᴀsɪʜ ᴅᴀʟᴀᴍ ᴛᴀʜᴀᴘ ᴘᴇʀᴋᴇᴍʙᴀɴɢᴀɴ ᴊɪᴋᴀ ᴀᴅᴀ ʙᴜɢ sɪʟᴀʜᴋɴ ʟᴀᴘᴏʀ ᴋᴇ ᴏᴡɴᴇʀ.

*ᴘᴏᴡᴇʀᴇᴅ ʙʏ DidinSec〆*⁩ @${ptod.split('@')[0]}`, {jpegThumbnail:iye}, [{buttonId: `command`,buttonText:{displayText: 'ᴍᴇɴᴜ'},type:1},{buttonId:`rules`,buttonText:{displayText:'ʀᴜʟᴇs'},type:1}], {contextInfo: { mentionedJid: [ptod,stod]}}, { quoted : mek })
...
│ ⛀̷ ${prefix}ytmp3
│ ⛀̷ ${prefix}play query
│ ⛀̷ ${prefix}instagram <url>
│ ⛀̷ ${prefix}twitter <url>
└⬣
...
sendButLocation(from, `${menu}`, `
╭─⬣「 Group Menu 」⬣
│ ⛀̷ ${prefix}grup [ 3 button ]
│ ⛀̷ ${prefix}promote </reply chat member>
│ ⛀̷ ${prefix}demote </reply chat member>
│ ⛀̷ ${prefix}setdesc
│ ⛀̷ ${prefix}nsfw 1/0
│ ⛀̷ ${prefix}setname
│ ⛀̷ ${prefix}kick </reply>
│ ⛀̷ ${prefix}add </reply>
│ ⛀̷ ${prefix}getbio </reply chat member>
│ ⛀̷ ${prefix}getname </reply chat member>
│ ⛀̷ ${prefix}reminder </msg/2s>
│ ⛀̷ ${prefix}listonline
│ ⛀̷ ${prefix}sider [reply chat bot]
│ ⛀̷ ${prefix}antilink
│ ⛀̷ ${prefix}tod
│ ⛀̷ ${prefix}tospam jumlah
│ ⛀̷ ${prefix}antihidetag
│ ⛀̷ ${prefix}antiviewonce
│ ⛀̷ ${prefix}autojoin
│ ⛀̷ ${prefix}antivirtex
│ ⛀̷ ${prefix}kickarea
└⬣
...
│ ⛀̷ ${prefix}unbanchat
│ ⛀̷ ${prefix}listbc
│ ⛀̷ ${prefix}antidelete on|off
│ ⛀̷ ${prefix}autoketik on|off
│ ⛀̷ ${prefix}autoread gc on / gc off
│ ⛀̷ ${prefix}autovn on / off
│ ⛀̷ ${prefix}anticall on / off
│ ⛀̷ ${prefix}getcaption
│ ⛀̷ ${prefix}bugkatalog
│ ⛀̷ ${prefix}buggc [ id grup ]
│ ⛀̷ ${prefix}okvirtex
│ ⛀̷ ${prefix}on
│ ⛀̷ ${prefix}status
│ ⛀̷ ${prefix}setthumb
...
│ ⛀̷ ${prefix}hacked
│ ⛀̷ ${prefix}setprefix
│ ⛀̷ ${prefix}mode [2 button self/public]
│ ⛀̷ ${prefix}term </code>
│ ⛀̷ ${prefix}eval </code>
│ ⛀̷ ${prefix}colongsw [reply sw]
└⬣
...
│ ⛀̷ ${prefix}join
│ ⛀̷ ${prefix}dadu
│ ⛀̷ ${prefix}bilangangka number
bilangangka number
│ ⛀̷ ${prefix}kalkulator
│ ⛀̷ ${prefix}pantun
│ ⛀̷ ${prefix}quote
│ ⛀̷ ${prefix}nuliskanan teks
│ ⛀̷ ${prefix}nuliskiri teks
│ ⛀̷ ${prefix}foliokiri teks
│ ⛀̷ ${prefix}foliokanan teks
│ ⛀̷ ${prefix}ss link web
│ ⛀̷ ${prefix}liriklagu </query>
│ ⛀̷ ${prefix}artinama </name>
│ ⛀̷ ${prefix}debug
│ ⛀̷ ${prefix}loli
│ ⛀̷ ${prefix}debug2
│ ⛀̷ ${prefix}infogempa
│ ⛀̷ ${prefix}resepmasakan
│ ⛀̷ ${prefix}chat 62|P
│ ⛀̷ ${prefix}caripesan </query>
│ ⛀̷ ${prefix}get url
│ ⛀̷ ${prefix}githubstalk </query>
│ ⛀̷ ${prefix}ytserach </query>
│ ⛀̷ ${prefix}igstalk </query>
│ ⛀̷ ${prefix}tiktokstalk </query>
│ ⛀̷ ${prefix}play </query>
│ ⛀̷ ${prefix}video </query>
│ ⛀̷ ${prefix}igstory </username>
│ ⛀̷ ${prefix}twitter </link>
│ ⛀̷ ${prefix}tiktok </link>
│ ⛀̷ ${prefix}fb </link>
│ ⛀̷ ${prefix}brainly </query>
│ ⛀̷ ${prefix}image </query>
│ ⛀̷ ${prefix}anime </random>
│ ⛀̷ ${prefix}pinterest </query>
│ ⛀̷ ${prefix}komiku </query>
│ ⛀̷ ${prefix}lirik </query>
│ ⛀̷ ${prefix}chara </query>
│ ⛀̷ ${prefix}playstore </query>
│ ⛀̷ ${prefix}otaku </query>
└⬣
...
╭─⬣「 Maker Menu 」⬣
│ ⛀̷ ${prefix}sticker
│ ⛀̷ ${prefix}swm </author|packname>
│ ⛀̷ ${prefix}take </author|packname>
│ ⛀̷ ${prefix}attp teks
│ ⛀̷ ${prefix} fancytekt teks
│ ⛀̷ ${prefix}emoji
│ ⛀̷ ${prefix}hallowen teks
│ ⛀̷ ${prefix}vampire teks
│ ⛀̷ ${prefix}codetxt teks
│ ⛀̷ ${prefix}matrik teks
│ ⛀̷ ${prefix}googletxt teks
│ ⛀̷ ${prefix}express
│ ⛀̷ ${prefix}maker2d2 teks
│ ⛀̷ ${prefix}maker2d3 teks
│ ⛀̷ ${prefix}maker2d4 teks
│ ⛀̷ ${prefix}maker3d teks
│ ⛀̷ ${prefix}golden teks
│ ⛀̷ ${prefix}flower teks
│ ⛀̷ ${prefix}dance
│ ⛀̷ ${prefix}wooden teks
│ ⛀̷ ${prefix}burn teks
│ ⛀̷ ${prefix}glow teks
│ ⛀̷ ${prefix}summer teks
│ ⛀̷ ${prefix}neon teks
│ ⛀̷ ${prefix}coffeecup2 teks
│ ⛀̷ ${prefix}coffeecup teks
│ ⛀̷ ${prefix}battlefield teks|teks
│ ⛀̷ ${prefix}googletxt2 teks
│ ⛀̷ ${prefix}transformer teks
│ ⛀̷ ${prefix}nulis teks
│ ⛀̷ ${prefix}text3d teks
│ ⛀̷ ${prefix}warrior teks
└⬣
...
sendButLocation(from, `${menu}`, `
╭─⬣「 Game Menu 」⬣
│ ⛀̷ ${prefix}tembak udara
│ ⛀̷ ${prefix}tembak darat
│ ⛀̷ ${prefix}tembak laut
│ ⛀̷ ${prefix}tebakgambar
│ ⛀̷ ${prefix} suit batu/gunting/kertas
│ ⛀̷ ${prefix}slot
│ ⛀̷ ${prefix}dadu
│ ⛀̷ ${prefix}truth
│ ⛀̷ ${prefix}dare
...
case 'command':
 ...
 rows: [
                           ...
                           },
                          {
                           ...
                           {                           
                              "title": "18+ᴍᴇɴᴜ",
                              "description": "Menampilkan Fitur B*k*p",
                              "rowId": ""
                           },
                           {
                              "title": "ᴊᴀᴅɪʙᴏᴛ",
                           ...
                           {
                              "title": "ᴍᴀᴋᴇʀᴍᴇɴᴜ",
                              "description": "Edit Sesuatu D Bot",
                              "rowId": ""
                           },
                           {
                              "title": "ɢᴀᴍᴇᴍᴇɴᴜ",
                           ...
                           {
                           "title": "ᴡɪʙᴜᴍᴇɴᴜ",
                           "description": "Menampilkan Menu Untuk Para Wibu",
                           "rowId": ""
                           },
                           {
                              "title": "ɴsғᴡᴍᴇɴᴜ",
                              "description": "Menu/Nsfw18+",
                              "rowId": ""
                           },
                           {
                              "title": "ɢʀᴏᴜᴘᴍᴇɴᴜ",
                           ...
                           {
                              "title": "ɢᴀᴄʜᴀᴄᴇᴄᴀɴ",
                              "description": "Kirim Random Foto Cewe Cantik/Seksi",
                              "rowId": ""
                           },
                           {
                              "title": "ᴅᴏᴡɴʟᴏᴀᴅᴍᴇɴᴜ",
                           ...
                           {
                              "title": "ɢᴄʙᴏᴛ",
                              "description": "Group Official Bot",
                              "rowId": ""
                           },
                           {
                              "title": "ᴅɪᴅɪɴsʜᴏᴘ",
                           ...
                           {
                              "title": "sᴇᴡᴀʙᴏᴛ",
                              "description": "Untuk Menambahkan Bot Ke Group Anda",
                              "rowId": ""                           
                           }
                        ]
                     }],
...
case 'ᴅɪᴅɪɴsʜᴏᴘ':
       if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fgif})
 listMsg = {
 buttonText: '*ᴅɪᴅɪɴsʜᴏᴘ*',
 footerText: '©DidinSec〆⁩',
 description: `ʜᴀɪ ᴋᴀᴋ @${sender.split('@')[0]}, ᴅɪᴅɪɴsʜᴏᴘ ᴅɪsɴɪ`,
 sections: [
                     {
                      "title": `${jam} - ${week} ${weton} - ${date}`,
 rows: [
...
©ᴅɪᴅɪɴsʜᴏᴘ⁩ @${ptod.split('@')[0]}`, {jpegThumbnail:didin}, [{ buttonId: `owner`, buttonText: { displayText: 'ᴏᴡɴᴇʀ️' }, type: 1 } ], {contextInfo: { mentionedJid: [ptod,stod]}}, { quoted : mek })
               buffer = fs.readFileSync(`./stmp3`)
ronove.sendMessage(from, buffer, audio, { mimetype: 'audio/mp4', quoted: fg3, ptt: true })
        break
case 'ᴋᴇʙᴜᴛᴜʜᴀɴʜᴏsᴛɪɴɢ':
case 'ᴋᴇʙᴜᴛᴜʜᴀɴʜᴏsᴛɪɴɢ':
       if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fgif})
        thu = await ronove.getStatus(`${sender.split('@')[0]}@s.whatsapp.net`, MessageType.text)
ptod = "6281545463585@s.whatsapp.net"
       ...
       stst = await ronove.getStatus(`${sender.split('@')[0]}@c.us`)
				stst = stst.status == 401 ? '' : stst.status
			menu = `ᴋᴇʙᴜᴛᴜʜᴀɴ ʜᴏsᴛɪɴɢ`
sendButLocation(from, `${menu}`, `*🌐ʀᴇᴀᴅʏ ᴀʟʟ ᴋᴇʙᴜᴛᴜʜᴀɴ ʜᴏsᴛɪɴɢ🌐*
*ᴅɪᴅɪɴsᴛᴏʀᴇ*

*🎗️ᴡᴇʙ ᴘɪsʜɪɴɢ*
• ᴡᴇʙ ᴘ 0x ɢᴀʀᴀɴsɪ : 10.000
• ᴡᴇʙ ᴘ 1x ɢᴀʀᴀɴsɪ : 15.000
• ᴡᴇʙ ᴘ 2x ɢᴀʀᴀɴsɪ : 20.000
• ᴡᴇʙ ᴘ 3x ɢᴀʀᴀɴsɪ : 25.000
========================
*🎗️ᴡʜᴍ*
• ᴡʜᴍ ᴍɪɴɪ : 30.000
• ᴡʜᴍ ᴍᴇᴅɪᴜᴍ : 40.000
   ...
   case 'pokemon':
      ...
      sticWait(from)
         ...
         case 'ss':
               if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fgif})
      sticWait(from)
					sendMediaURL(from, `https://didinsec.herokuapp.com/api/ssweb?apikey=didinxc}`, `Ni Kak`)
					break
case 'harta':
      if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fgif})
  sticWait(from)
...
case 'kalkulator':
				...
				case 'fancytext':
				if (args.length < 1) return reply('Teksnya?')
anu = await fetchJson(`https://didinsec.herokuapp.com/api/calculator?angka=11%20*%2045&apikey=didinxc`, {method: 'get'})
teks = anu.result
reply(teks)
break
	case 'halloween':
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fgif})
       ...
       stst = await ronove.getStatus(`${sender.split('@')[0]}@c.us`)
				stst = stst.status == 401 ? '' : stst.status
			tes = `blabla`
       anu = await fetchJson(`https://tinyurl.com/api-create.php?url=${dl_link}`)
      gett = anu.result
...
sendButLocation(from, `${ini_txt}`, `Pilih opsi dibawah ini.`, {jpegThumbnail:ini_txt2}, [{buttonId:`playvideo ${gett.source}`,buttonText:{displayText:'🎥VIDEO'},type:1}, {buttonId:`ytlagu ${gett.source}`,buttonText:{displayText:'🎵AUDIO'},type:1}], {contextInfo: { mentionedJid: [ptod,stod]}})
break;
      case "playvideo":
...
stod = `${sender}`
       ...
       ownerJid = "6281803609324@s.whatsapp.net"
				stst = stst.status == 401 ? '' : stst.status			
ᴅɪᴀᴍᴏɴᴅᴍʟ = `𝟭𝟬𝟬% 𝘼𝙈𝘼𝙉 𝙃𝘼𝙉𝙔𝘼 𝘽𝙐𝙏𝙐𝙃 𝙑𝙄𝘼 𝙄𝘿
